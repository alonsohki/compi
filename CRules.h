...
DECLARE_RULE(disyuncion_prima, nombre, tipo, gtrue, gfalse, literal, hnombre, htipo, hgtrue, hgfalse, hliteral);
DECLARE_RULE(conjuncion, nombre, tipo, gtrue, gfalse, literal);
DECLARE_RULE(conjuncion_prima, nombre, tipo, gtrue, gfalse, literal, hnombre, htipo, hgtrue, hgfalse, hliteral);
DECLARE_RULE(relacional, nombre, tipo, gtrue, gfalse, literal);
DECLARE_RULE(relacional_prima, nombre, tipo, gtrue, gfalse, literal, hnombre, htipo, hgtrue, hgfalse, hliteral);
DECLARE_RULE(aritmetica, nombre, tipo, gtrue, gfalse, literal);
DECLARE_RULE(aritmetica_prima, nombre, tipo, gtrue, gfalse, literal, hnombre, htipo, hgtrue, hgfalse, hliteral);
DECLARE_RULE(termino, nombre, tipo, gtrue, gfalse, literal);
DECLARE_RULE(termino_prima, nombre, tipo, gtrue, gfalse, literal, hnombre, htipo, hgtrue, hgfalse, hliteral);
...
DECLARE_RULE(lista_de_expr, hident, htipo, nombre);
DECLARE_RULE(resto_lista_expr, hident, htipo, hliteral, hdepth, hoffset, nombre);

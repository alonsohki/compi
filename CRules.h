...
DECLARE_RULE(argumentos, listaTipos, listaClase);
DECLARE_RULE(lista_de_param, listaTipos, listaClase);
DECLARE_RULE(resto_lis_de_param, hlistaTipos, hlistaClase, listaTipos, listaClase);

...
relacional'                                          	& $\longrightarrow$                     & \ter{ oprel } aritmetica relacional' \\
                                                                                                    & \sem{
                                                                                                        ...
                                                                                                        \} } \\
                                                        &                                           & \sem{
                                                                                                        relacional'.nombre = relacional'\textsubscript{1}.hnombre; \\
                                                                                                        relacional'.tipo = relacional'\textsubscript{1}.htipo; \\
                                                                                                        relacional'.gfalse = relacional'\textsubscript{1}.hgfalse; \\
                                                                                                        relacional'.gtrue = relacional'\textsubscript{1}.hgtrue; \\
...
aritmetica'                                         	& $\longrightarrow$                     & \ter{ opl2 } termino aritmetica' \\
                                                        &                                           & \sem{
                                                                                                        ...
                                                                                                        \} else \{ \\
                                                                                                            ...
                                                                                                            arimetica'\textsubscript{1}.htipo = NEW_BASIC_TYPE(UNKNOWN); \\
                                                                                                        \} } \\
                                                        &                                           & \sem{
                                                                                                        aritmetica'.nombre = aritmetica'\textsubscript{1}.hnombre; \\
                                                                                                        aritmetica'.tipo = aritmetica'\textsubscript{1}.htipo; \\
                                                                                                        aritmetica'.gfalse = aritmetica'\textsubscript{1}.hgfalse; \\
                                                                                                        aritmetica'.gtrue = aritmetica'\textsubscript{1}.hgtrue; \\
